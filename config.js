...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Will you be my valentine, my princess? :3",
    ...
    questions: {
        ...
        second: {
            ...
            startText: "This muchhhhhh",                                   // Text before the percentage
            nextBtn: "Onwards we go"                                         // Text for the next button
        },
        third: {
    ...
    colors: {
        backgroundStart: "#caa1ff",      // Gradient start (try pastel colors for a soft look)
        backgroundEnd: "#a0a2ff",        // Gradient end (should complement backgroundStart)
        buttonBackground: "#6b6dff",     // Button color (should stand out against the background)
